...
const Hero = ({ selColor }) => {
  ...
  useEffect(() => {
    init(textRef.current, { showCursor: true, strings: ['LLM & NLP & Prompt Egnieer', "Blockchain developer", "Gis developer", "Full Stack developer"] })
  }, []);
        ...
        >
          ...
          <div className="head2">
            <h1 className={`${styles.heroHeadText} `} style={{ color: selColor == "blue" ? 'green' : 'white' }}>
              Hi there, I'm <p className='name text-[#915EFF]'>Yevhenii Yevtushenko</p>
            </h1>
            <h3>
            ...
            <div className="absolute link1">
              <a
                href="https://github.com/newangry" target="_blank">
                <AiOutlineGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/yevhenii-yevtushenko-13b11129a" target="_blank">
                <ImLinkedin />
              </a>
            </div>
